...
Loads BRAM with coe files of samples -> puts that in a BRAM controller with uart configuration for each sample (hex 8 bit stuff) -> uses switches to alter the type of sound effect needed -> puts that into the i2s protocal transmitter to your audio dac of choice
